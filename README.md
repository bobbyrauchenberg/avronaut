...
Encoding and decoding does not require you to pass schemas around either explicitly or implicitly. However sometimes you might need access to the schema that has been generated. They can be retrieved via the Encoder API
